    ...
    <div id="wrap">
        <?php
            ...
            if($stmt -> rowCount() != 0){
                ...
                $stmt->bindParam(':hashLink', $hash);
                $stmt->execute();
                echo '<div class="statusmsg">Your account has been activated,
                you can now login.</div>';
            }
            else{
                // No match -> invalid url or account has already been activated.
                echo '<div class="statusmsg">The url is either invalid or you already
                have activated your account.</div>';
            }
        }
        else{
            // Invalid approach
            echo '<div class="statusmsg">Invalid approach, please use the link that
